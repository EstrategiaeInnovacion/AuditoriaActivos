        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-xl shadow-sm">
                    <div class="flex items-start">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-amber-500 mt-0.5" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>
                        </div>
                        <div class="ml-3 flex-1">
                            <h3 class="text-sm font-semibold text-amber-800"><span role="img" aria-label="Advertencia">⚠️</span> Garantías por vencer (próximos 30 días)</h3>
                ...
                <div class="bg-red-50 border-l-4 border-red-400 p-4 rounded-r-xl shadow-sm">
                    <div class="flex items-start">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-red-500 mt-0.5" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        </div>
                        <div class="ml-3 flex-1">
                            <h3 class="text-sm font-semibold text-red-800"><span role="img" aria-label="Alerta">🔴</span> Préstamos vencidos (+30 días sin devolución)</h3>
                            <div class="mt-2 space-y-1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 flex items-center transition-all hover:-translate-y-1 hover:shadow-2xl duration-300">
                    <div class="p-3 rounded-2xl bg-gradient-to-br from-slate-100 to-slate-200 text-slate-600 mr-4 shadow-inner">
                        <svg class="w-8 h-8" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z"></path></svg>
                    </div>
                    <div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-xl shadow-emerald-100/50 border border-slate-100 flex items-center transition-all hover:-translate-y-1 hover:shadow-2xl duration-300 relative overflow-hidden group">
                    ...
                    <div class="p-3 rounded-2xl bg-gradient-to-br from-emerald-50 to-emerald-100 text-emerald-600 mr-4 shadow-inner group-hover:scale-110 transition-transform">
                        <svg class="w-8 h-8" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                    </div>
                    <div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-xl shadow-blue-100/50 border border-slate-100 flex items-center transition-all hover:-translate-y-1 hover:shadow-2xl duration-300 relative overflow-hidden group">
                    ...
                    <div class="p-3 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-blue-600 mr-4 shadow-inner group-hover:scale-110 transition-transform">
                        <svg class="w-8 h-8" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                    </div>
                    <div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-xl shadow-amber-100/50 border border-slate-100 flex items-center transition-all hover:-translate-y-1 hover:shadow-2xl duration-300 relative overflow-hidden group">
                 ...
                 <div class="bg-white p-6 rounded-2xl shadow-xl shadow-red-100/50 border border-slate-100 flex items-center transition-all hover:-translate-y-1 hover:shadow-2xl duration-300 relative overflow-hidden group">
                    ...
                    <div class="p-3 rounded-2xl bg-gradient-to-br from-red-50 to-red-100 text-red-600 mr-4 shadow-inner group-hover:scale-110 transition-transform">
                        <svg class="w-8 h-8" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>
                    </div>
                    <div>
                ...
                <div class="space-y-8 order-1 lg:order-2">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <a href="{{ route('devices.create') }}" class="group flex flex-row sm:flex-col items-center justify-start sm:justify-center p-4 rounded-xl bg-slate-50 hover:bg-white border border-transparent hover:border-cyan-200 hover:shadow-lg hover:shadow-cyan-100 transition-all text-slate-700">
                                <div class="p-3 bg-indigo-50 text-indigo-500 rounded-full group-hover:bg-cyan-50 group-hover:text-cyan-600 transition-colors mr-3 sm:mr-0 sm:mb-2">
                                    <svg class="w-6 h-6" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg>
                                </div>
                                <span class="text-sm font-semibold text-center">Nuevo Activo</span>
                            </a>
                            <button @click="showQrScanner = true" class="group flex flex-row sm:flex-col items-center justify-start sm:justify-center p-4 rounded-xl bg-slate-50 hover:bg-white border border-transparent hover:border-indigo-200 hover:shadow-lg hover:shadow-indigo-100 transition-all text-slate-700">
                                <div class="p-3 bg-cyan-50 text-cyan-500 rounded-full group-hover:bg-indigo-50 group-hover:text-indigo-600 transition-colors mr-3 sm:mr-0 sm:mb-2">
                                    <svg class="w-6 h-6" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v1m6 11h2m-6 0h-2v4h-4v-4H8m13-9v2m-3-2v2m-3-2v2m3 6v2m-3-2v2m-3-2v2m-3-2v2m3-2v2m-3-2v2m6 10v2m-3-2v2m-3-2v2m-3-2v2m-3-2v2m-3-2v2m-3-2v2"></path></svg>
                                </div>
                                <span class="text-sm font-semibold text-center">Escanear QR</span>
                            </button>
                            <button @click="showQrScanner = true; $nextTick(() => { Livewire.dispatch('setQuickMode') })" class="group flex flex-row sm:flex-col items-center justify-start sm:justify-center p-4 rounded-xl bg-gradient-to-br from-amber-50 to-amber-100/50 hover:from-amber-100 hover:to-amber-200/50 border border-transparent hover:border-amber-300 hover:shadow-lg hover:shadow-amber-100 transition-all text-amber-700">
                                <div class="p-3 bg-amber-100 text-amber-600 rounded-full group-hover:bg-amber-200 group-hover:text-amber-700 transition-colors mr-3 sm:mr-0 sm:mb-2">
                                    <svg class="w-6 h-6" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                                </div>
                                <span class="text-sm font-semibold text-center">Modo Rápido</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                        <h3 class="text-lg font-semibold text-slate-800 mb-4"><span role="img" aria-label="Tendencia">📈</span> Tendencia Mensual</h3>
                        <div class="space-y-2">
            ...
            <div x-show="showQrScanner" style="display: none;" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"
                ...
                x-init="$watch('showQrScanner', value => {
                    if (value) {
                        $nextTick(() => { $el.querySelector('button')?.focus(); });
                    }
                })"
                @keydown.tab.prevent="
                    const focusable = [...$el.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex=\'-1\'])')].filter(el => !el.disabled && el.offsetParent !== null);
                    if (!focusable.length) return;
                    const first = focusable[0];
                    const last = focusable[focusable.length - 1];
                    if ($event.shiftKey) {
                        (document.activeElement === first ? last : focusable[focusable.indexOf(document.activeElement) - 1] || last).focus();
                    } else {
                        (document.activeElement === last ? first : focusable[focusable.indexOf(document.activeElement) + 1] || first).focus();
                    }
                "
            >
